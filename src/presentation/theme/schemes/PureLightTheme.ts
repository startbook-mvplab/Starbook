...
const colors = {
  ...
  shadows: {
    ...
    card: '0px 9px 16px rgba(159, 162, 191, .18), 0px 2px 2px rgba(59, 162, 191, 0.32)',
    cardSm:
      '0px 2px 3px rgba(159, 162, 191, .18), 0px 1px 1px rgba(0, 162, 191, 0.32)',
    cardLg:
      '0 5rem 14rem 0 rgb(255 255 255 / 30%), 0 0.8rem 2.3rem rgb(0 0 0 / 60%), 0 0.2rem 0.3rem rgb(0 0 0 / 45%)'
  },
  layout: {
    general: {
      bodyBg: 'rgba(1, 1, 1, 0.71)'
    },
    sidebar: {
      background: 'black',//themeColors.white,
  ...
  primary: {
    ...
    dark: themeColors.primary,//darken(themeColors.primary, 0.2)
  },
  success: {
...
export const PureLightTheme = createTheme({
  ...
  palette: {
    ...
    text: {
      ...
      secondary: colors.alpha.white[50],
    ...
    action: {
      active: colors.alpha.white[70],
      // hover: 'red',//colors.primary.lighter,
      hoverOpacity: 0.1,
